...
Otsukare is a personal project for Japanese language learning open to contributors.
...
- [ ] On local dev branch, increment the project version by updating `otsukare.__init__.py`
